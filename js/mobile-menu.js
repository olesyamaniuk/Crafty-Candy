document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-navigation-list");
  const headerRef = document.querySelector(".q-header");
  const navigationRef = document.querySelector(".q-navigation");
